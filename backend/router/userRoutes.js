...
const { getProfile, getNotice, postNotice, updateProfile, setTemporaryMeal, getTemporaryMeal, removeMyTempMeal, deleteTempMeal, getMealMonth, getAllMealMonth } = require('../controller/userController')
